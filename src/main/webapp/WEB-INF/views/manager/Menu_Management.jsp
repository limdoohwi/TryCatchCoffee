...
<script>
	...
	$(function() {
		...
		$("#Menu-Insert-Btn").click(function(){
	         ...
	         var formdata = new FormData(document.getElementById("Menu-Insert-Form"));
	         $.ajax({
	         	url: 'insert.menu.manager',
	            processData: false,
	            contentType: false,
	            data: formdata,
	            type: 'POST',
							...
							<tr>
								<td id="Menu-Table-Check-td" " class="text-center">
									...
									<div id="Menu-Select-Single-Check-Div">
										<a id="Menu-Table-Show-Icon-Btn" class="btn"
								...
								<td align="center"><a class="Menu-Table-Update-Btn btn btn-default"><em class="fa fa-pencil"></em></a></td>
							</tr>
							<tr>
								<td id="Menu-Table-Check-td" " class="text-center">
									<!-- 선택 div -->
			...
			<div class="panel panel-default panel-table col-md-5" style="display:inline-block; margin-right: 20px">
				...
				<div class="panel-body">
					<div id="Menu-Insert-Div" style="display: none;">
						<form class="form-horizontal" id="Menu-Insert-Form" enctype="multipart/form-data">
							...
							<div style="display:inline-block;">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="password" class="form-control" name="menu_price" required="required"
