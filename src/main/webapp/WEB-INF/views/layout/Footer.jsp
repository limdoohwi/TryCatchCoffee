...
<!-- Footer -->
	<footer class="text-center" style="margin-top: 250px !important; margin-bottom: 0px !important;">
		...
		<div class="footer-below">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">Copyright &copy; TryCoffeeCatch{} 2016</div>
				</div>
			</div>
		</div>
	</footer>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<ul class="list-inline item-details">
								...
								<li>Date: <strong><a
										href="http://startbootstrap.com">2016</a> </strong>
								</li>
								<li>Service: <strong><a
										href="http://startbootstrap.com">Web Development</a> </strong>
								</li>
