...
<div class="collapse navbar-collapse" id="Main-DropDown-Nav">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<ul class="Main-DropDown-Menu nav navbar-nav" style="width: 100%;">
			...
			<!-- dropdown menu -->
			<div
				style="padding-top: 40px; display: inline-block; margin-left: 115px">
				<!-- TryCoffee Menu -->
				<div style="display: inline-block;">
					<a name="Company" role="menuitem" tabindex="-1"
						href="front?cmd=trycoffee&check=company">회사소개</a><br /> <a
						name="Ceo" role="menuitem" tabindex="-1"
						href="front?cmd=trycoffee&check=ceo">CEO 인사말</a><br />
				</div>
				<!-- Order Menu -->
				<div style="display: inline-block; margin-left: 15px">
					<a name="Drink" role="menuitem" tabindex="-1"
						href="front?cmd=order&check=drink">음료 주문 예약</a><br /> <a
						name="MeetingRoom" id="MeetingRoom-Btn" role="menuitem"
						tabindex="-1" href="#">미팅룸 예약</a><br />
				</div>
				<!-- Community Menu -->
				<div style="display: inline-block; margin-left: 13px">
					<a name="Recipe" role="menuitem" tabindex="-1" href="#">Recipe<br />Contest
					</a><br /> <a name="Client" role="menuitem" tabindex="-1" href="#">고객의
						소리</a><br />
				</div>
				<!-- Manager Menu -->
				<div style="display: inline-block; margin-left: 30px">
					<a name="Member-Manage" role="menuitem" tabindex="-1"
						href="front?cmd=manager&check=member">회원 관리</a><br /> <a
						name="Store-Manage" role="menuitem" tabindex="-1"
						href="front?cmd=manager&check=store">매장 관리</a><br /> <a
