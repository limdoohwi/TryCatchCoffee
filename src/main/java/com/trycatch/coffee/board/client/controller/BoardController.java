...
public class BoardController {
	...
	public String replyPOST(HttpServletRequest req, BoardDTO board, RedirectAttributes rttr, int member_no, int parent_board_num, int board_group) throws Exception{
		board.setBoard_ip(req.getRemoteAddr());
